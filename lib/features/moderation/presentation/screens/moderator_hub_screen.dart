...
import 'package:travelcompanion/features/moderation/presentation/screens/moderator_users_screen.dart';

class ModeratorHubScreen extends StatelessWidget {
  const ModeratorHubScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const PreferredSize(
        ...
        child: AppBarWidget(title: 'Панель модерации'),
      ),
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _ModeratorTile(
                ...
                onTap: () => Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (_) => const ModeratorUsersScreen(),
                  ),
                ),
              ),
            ],
